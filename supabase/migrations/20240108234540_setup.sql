...
AS $$
DECLARE
  project_url TEXT := 'https://xgcqtooczoiencfaiyzq.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhnY3F0b29jem9pZW5jZmFpeXpxIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1Mjg3NDA2OCwiZXhwIjoyMDY4NDUwMDY4fQ.j7D7mEwB2FwwDUsVeEFp2IpKZYCvw-PQVM55gKOaXNs'; -- full access needed for http request to storage
